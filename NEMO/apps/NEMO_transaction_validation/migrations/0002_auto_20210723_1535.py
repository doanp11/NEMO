# Generated by Django 2.2.24 on 2021-07-23 19:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', mptt.fields.TreeForeignKey(help_text='The area accessed during this record', on_delete=django.db.models.deletion.CASCADE, to='NEMO.Area')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_approved', models.BooleanField(default=False, help_text='<b>Check this to approve the contest and to apply the changes when saving this form</b>')),
                ('area_access_records', models.ManyToManyField(help_text='Area Access Record contests', to='NEMO_transaction_validation.ContestAreaAccessRecord')),
